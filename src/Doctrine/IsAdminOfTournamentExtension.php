...
final class IsAdminOfTournamentExtension implements QueryCollectionExtensionInterface, QueryItemExtensionInterface
{
    ...
    private function addWhere(QueryBuilder $queryBuilder, string $resourceClass)
    {
        ...
        if ($user instanceof User && GlobalTournament::class === $resourceClass && !$this->authorizationChecker->isGranted('ROLE_ADMIN')) {

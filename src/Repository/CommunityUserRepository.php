 ...
 */
class CommunityUserRepository extends ServiceEntityRepository
{
    ...
    // /**
    //  * @return CommunityUser[] Returns an array of CommunityUser objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?CommunityUser
    {
        return $this->createQueryBuilder('c')
            ->andWhere('c.exampleField = :val')
            ->setParameter('val', $value)
